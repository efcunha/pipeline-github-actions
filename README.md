...
- [Link Repositório pipeline-gitlab-ci:](https://gitlab.com/efcunha/pipeline-gitlab-ci.git)

- [Azure DevOps Services](https://docs.microsoft.com/en-us/azure/devops/pipelines/yaml-schema/?view=azure-pipelines)
